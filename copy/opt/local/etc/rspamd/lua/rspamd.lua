...
dofile('/opt/local/etc/rspamd/lua/regexp/headers.lua')
dofile('/opt/local/etc/rspamd/lua/regexp/lotto.lua')
dofile('/opt/local/etc/rspamd/lua/regexp/fraud.lua')
dofile('/opt/local/etc/rspamd/lua/regexp/drugs.lua')
